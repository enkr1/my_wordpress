  ...
  if (window.location.pathname.includes("category/blog")) {
    ...
    window.onload = function () {
      ...
      for (var i = 0; i < stat_names.length; i++) {
        ...
        var stat_name = stat_names[i].innerHTML; // console.log(stat_colors[stat_name]);
      ...
      for (var i = 0; i < pokemon_card.length; i++) {
        ...
        console.log(pokemon_card[i].innerHTML); // var stat_name = stat_names[i].innerHTML;
        // stat_number[i].style.color = stat_colors[stat_name];
      }
      ...
      function enlargeCard() {
        ...
        str = str.substring(0, n) + "_hires" + str.substring(n); // console.log(str);

        img.src = str; // img.style.backgroundImage = "url(" + this.src + ")";
        // alert(this.src);
      }
