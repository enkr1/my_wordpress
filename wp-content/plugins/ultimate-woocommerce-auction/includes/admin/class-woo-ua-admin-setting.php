 ...
 /**
	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_' . $this->id . '_settings', array(
			...
			array(
				'title' 		=> __( "Enable an alert box", 'woo_ua' ),
				'desc' 			=> __( 'Enable an alert box before bid', 'woo_ua' ),
				'type' 				=> 'checkbox',
				'id'			=> 'woo_ua_auctions_bids_alert_box_tab',
				'default' 		=> 'yes',
				'checkboxgroup'   => 'start',
			),

			array(
				'title' 		=> __( "Enable an alert box for confirmation when user places a bid.", 'woo_ua' ),
				'desc' 			=> __( 'Option alert box for confirmation when user places a bid.', 'woo_ua' ),
				'type' 				=> 'checkbox',
				'checkboxgroup'   => 'end',
				'id'			=> 'woo_ua_auctions_alertbox',
				'default' 		=> 'yes'
			),
